...
stats <- ddply(subset(data, Benchmark != "TreeSort" & Benchmark != "PageRank" & Benchmark != "Json" & Benchmark != "GraphSearch" & Benchmark != "WhileLoop" & Benchmark != "IntegerLoop" & Benchmark != "FieldLoop"), ~ Benchmark + VM + Suite,
               summarise,
